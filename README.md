...
한국 식품 표시·광고 규정(식품표시광고법, 식품등의 표시기준, 건강기능식품 표시기준, 부당한 표시·광고의 내용 기준) 원문 발췌 지식베이스와 Claude API로 제품 문구를 사전 점검하는 도구입니다. 미국(FDA)·일본(식품표시기준) 수출 라벨 사전 점검 모드를 포함합니다(핵심 요약 자료 기반, 참고용).
...
- `exportkb.js` — 미국 FDA·일본 식품표시기준 핵심 요약 (수출 검수 참고자료, 원문 아님)
- `wrangler.toml` — 배포 설정
